...
public class ActorAnimator
{
    ...
    public virtual void Initialize(GameObject chrObj)
    {
    }
    ...
    public virtual void SwitchAnimation(int st, float playbackSpeed = 1.0f)
    {
        // FIXME
        /*
        if (mSpineAnim != null && mCurrentState != st)
        {
            mSpineAnim.AnimationName = GetAnimNameByState(st);
            mCurrentState = st;
            mPlaybackSpeed = playbackSpeed;
            mSpineAnim.timeScale = playbackSpeed;
        }*/
    }
    ...
    public virtual void SetPlaybackSpeed(float speed, bool ignoreInGameTimeScale = false)
    {
